...
//                           ),
//                           TextSpan(
//                             text: hitmeupProvider.hitMeUpCategory,
...
//                                   hintText: "Hit me up for a ${hitmeupProvider.hitMeUpCategory}",
...
//                               // materialPageRoute(context, SearchLocationScreen());
//                             },
...
//                             children: [
//                               Text(
//                                 "${hitmeupProvider.hitMeUpCategory} Details",
//                                 style: const TextStyle(
//                                     color: Colors.white,
//                                     fontWeight: FontWeight.w400,
//                                     fontSize: 16),
...
//                               style: const TextStyle(color: Colors.white),
//                               decoration: InputDecoration(
//                                   hintText: "Please write here ${hitmeupProvider.hitMeUpCategory} details",
//                                   border: InputBorder.none,
//                                   hintStyle: const TextStyle(color: Color(0xffCFCFCF))),
//                             ),
//                           ),
...
//         child: Row(children: [
//           const Icon(Icons.location_on_rounded,  color: Color(0xFFE94057),),
//           const SizedBox(
//             width: 10,
//           ),
//           Flexible(
